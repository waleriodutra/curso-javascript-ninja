...
*/
var text = 'Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – Rio de Janeiro, 18 de julho de 1875), apelidado de "O Centauro de Luvas", foi um militar, político, abolicionista e monarquista brasileiro. 19 de abril de 2000.';
...
console.log(text.replace(/Manuel Marques de Sousa/g, 'Antonio Dutra'));
/*
...
console.log(text.replace(/brasileiro/g, 'alagoano'));
...
function maiuscula(lal){
    return lal.toUpperCase(); 
}
console.log(text.replace(/O Centauro de Luvas/g, maiuscula));// function(deveAlterar){
//     return deveAlterar.toUpperCase();
// }));
...
var regexDate = /(\d\d) de (junho|julho|abril) de (\d\d\d\d)/g;
...
*/
console.log( '\nReplace de datas:' );
function replaceDate(grupo, dia, mes, ano){
