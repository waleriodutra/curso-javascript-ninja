...
*/
/*
    Descrição esta cagada, manda somar 1 ao ultimo numero, na realidade soma com o primeiro
var operation = justMod2Or3.reduce(function(acumulado, atual, item, array){
...
/*
    Descrição esta cagada, manda somar 1 ao ultimo numero, na realidade soma com o primeiro
var operation2 = justMod2Or3.reduceRight(function(acumulado, atual, item, array){
    if (item === array.length-1){
        atual++;
    }
    return acumulado * atual;
...
/* 
    Com letras 
var name = ['W', 'A', 'L', 'E', 'R', 'I', 'O'];
function naoEhVogal(a){
    return a !== 'A' && a !== 'E' && a !== 'I' && a !== 'O' && a !== 'U';
};
var reduce = name.reduce(function(acumulado, atual, item, array){
    if (acumulado.length === 1 && naoEhVogal(array[0]) ){
        acumulado = 'P';
    }
    if(naoEhVogal(atual)){
        atual = 'P';
