//(
	...
	*/
	console.log( 'O resultado da soma é:', sum(function(numa, numb){ return numa + numb;}));
	// ?
	...
	*/
	var subtraction = calculator(14, 10);
	var multiplication = calculator(4, 10);
	var division = calculator(15, 3);
	var mod = calculator(11, 4);
	...
	chamada.
	*/
	console.log( 'O resultado da subtração é:', subtraction(function(numa, numb){ return numa - numb;}) );
	// ?

	console.log( 'O resultado da multiplicação é:', multiplication(function(numa, numb){ return numa * numb;}) );
	// ?

	console.log( 'O resultado da divisão é:', division(function(numa, numb){ return numa / numb;}) );
	// ?

	console.log( 'O resto da divisão é:', mod(function(numa, numb){ return numa % numb;}) );
	// ?
//)();